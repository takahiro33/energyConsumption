...
int main (int argc, char *argv[])
{
	...
	cmd.AddValue ("proactive", "Enable proactive interest", proactive);
	...
	if(proactive)	consumerHelper.Install (centralContainer);			//change here (normal / proactive interest)

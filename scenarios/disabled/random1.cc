...
//	allNdnNodes.Add (firstLevel);
	...
	Vector pos1 (50, -100, 0.0);
	initialServer->Add (pos1);
...
*/
	...
	ptpServerlowerNdnDevices.Add (p2p_100mbps5ms.Install (serverNodes.Get (0), centralContainer.Get (0)));
...
*/
	...
	double checkTime = 10.0 / finalspeed;
	double j = apsec;
